...
function setColor ()
{
  ...
  if (facebook != null && instagram != null && twitter != null && linkedin != null)
  {
    ...
    youtube.setAttributeNS(null,"fill",localStorage.getItem("textColor"));
  }
}
...
{
  document.body.style.fontSize = localStorage.getItem ("fontSize"); //Sets the font size of the text to the selected value

  for (let i = 0; i < evenSections.length; i++)
  {
    oddSections[i].style.fontSize = localStorage.getItem("fontSize"); //Sets the font size of the text in the table
  }
}
